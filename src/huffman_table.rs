...
pub fn get_compressed_value(uncompressed_byte: u8) -> u32 {
    VALUES[uncompressed_byte as usize]
}

pub fn get_compressed_value_bit_count(uncompressed_byte: u8) -> u8 {
    BIT_COUNTS[uncompressed_byte as usize]
}
